...
/* Dummy thermal governor for system monitor - minimal implementation for 6.18+ */
			     ...
			     unsigned long mode, void *_unused)
{
	...
	case PM_SUSPEND_PREPARE:
		...
		rockchip_set_system_status(SYS_STATUS_SUSPEND);  /* Was FB_EVENT_BLANK */
		break;
	...
	case PM_POST_SUSPEND:
		...
		rockchip_clear_system_status(SYS_STATUS_SUSPEND);  /* Was FB_EVENT_BLANK */
		break;
	default:
		break;
	}
...
/*
 * FB_EVENT_BLANK was removed in kernel 6.6+
 * Framebuffer blank/unblank tracking migrated to PM notifier (monitor_pm_notify)
 * which now handles SYS_STATUS_SUSPEND on PM_SUSPEND_PREPARE/PM_POST_SUSPEND
 */
#if 0  /* CONFIG_FB - disabled, FB_EVENT_BLANK removed in 6.6+ */
...
static int rockchip_system_monitor_probe(struct platform_device *pdev)
{
	...
	/* FB notifier disabled - FB_EVENT_BLANK removed in 6.6+, using PM notifier instead */
#if 0  /* CONFIG_FB */
